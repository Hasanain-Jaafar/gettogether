    ...
    <div className="mx-auto flex h-[calc(100vh-8rem)] max-w-2xl flex-col">
          ...
          messages.map((m, i) => {
            ...
            return (
              ...
              >
                <div
                  className={cn(
                    "max-w-[75%] rounded-2xl px-4 py-2 text-sm whitespace-pre-wrap wrap-break-word",
                    mine
      ...
      >
        <Textarea
          ...
          className="min-h-[44px] max-h-32 flex-1 resize-y rounded-2xl border-border bg-muted/30 text-sm"
          maxLength={2000}
          disabled={sending}
        />
        <Button
